...
images = cv2.imread(r"E:\PyProjects\Faster-RCNN\Database\realdata-HPB\trainset\Images\0.png")
images = images.reshape([1, 705, 705, -1])

with open(r"E:\PyProjects\Faster-RCNN\Database\realdata-HPB\trainset\trainset.json", "r") as infile:
        ...
        iaa.SomeOf((2, 3),
                   [
                       ...
                       iaa.OneOf([
                           ...
                           iaa.Add((-150, 50), per_channel=True),
                       ...
                       sometimes(iaa.ElasticTransformation(alpha=(0.25, 4.0), sigma=0.25)), # move pixels locally around (with random strengths)
...
for i in range(1, 1000):
    ...
    cv2.imwrite(r"E:\PyProjects\Faster-RCNN\Database\realdata-HPB\trainset\Images\\" + str(i) + ".png", images_aug)

    id = id0.copy()
    id["file_name"] = str(i) + ".png"
    id["id"] = i
...
with open(r'E:\PyProjects\Faster-RCNN\Database\realdata-HPB\trainset\trainset1.json', 'w') as json_file:
