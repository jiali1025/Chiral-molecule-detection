...
labelme_json=glob.glob('C:/Users/yz18514/detectron2/Faster_RCNN_New/data/train_annotations/*.json')  # Get all .json files in the current directory.

lab = labelme2coco(labelme_json,'C:/Users/yz18514/detectron2/Faster_RCNN_New/data/train.json')       # Call labelme2coco class.
