...
def setup(args):
    ...
    cfg.INPUT.MAX_SIZE_TRAIN = 750              # maximum size of input image in training set.
    cfg.INPUT.MAX_SIZE_TEST = 750               # maximum size of input image in testing set.
    cfg.INPUT.MIN_SIZE_TRAIN = (500, 750)       # minimum size of input image in training set.
    cfg.INPUT.MIN_SIZE_TRAIN_SAMPLING = 'range'
    cfg.INPUT.MIN_SIZE_TEST = 500               # minimum size of input image in testing set.
