...
if __name__ == "__main__":
    ...
    cfg.INPUT.MAX_SIZE_TRAIN = 600              # maximum size of input image in training set.
    cfg.INPUT.MAX_SIZE_TEST = 600               # maximum size of input image in testing set.
    cfg.INPUT.MIN_SIZE_TRAIN = (180, 520)       # minimum size of input image in training set.
    cfg.INPUT.MIN_SIZE_TRAIN_SAMPLING = 'range'
    cfg.INPUT.MIN_SIZE_TEST = 180

    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 1   # set the testing threshold for this model
